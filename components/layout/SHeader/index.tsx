	...
	return (
		<header className="py-4 px-2 border-b border-[#DBDBDB]">
			<div className="grid grid-cols-4 items-center gap-4">
				<Title className={originalSurfer.className} c={'violet'} fw={'bold'} order={1}>Rose</Title>
				...
				<div className="flex items-center gap-2 justify-end">
					<ActionIcon c={'dark'} variant="subtle">
						<IconMessage />
					</ActionIcon>
					<Indicator inline label="6" color={'red'} size={16}>
						<ActionIcon c={'dark'} variant="subtle">
							<IconBell />
						</ActionIcon>
					</Indicator>
						...
						<Menu.Target>
							<Group gap={'xs'}>
								...
								<Group gap={4}>
									...
									<ActionIcon variant='subtle' c={'dark'}>
